...
class Settings:
    ...
    # Per-task model overrides (empty string = use model_name)
    extraction_model: str = _env("KING_EXTRACTION_MODEL", "mistralai/mistral-large-3-675b-instruct-2512")
    generation_model: str = _env("KING_GENERATION_MODEL", "qwen/qwen3.5-397b-a17b")
