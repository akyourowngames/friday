...
def make_settings(root: Path, tavily_api_key: str = "") -> Settings:
    return Settings(
        ...
        tool_router_prompt=str(root / "prompts" / "tool_router.md"),
        tool_verifier_prompt=str(root / "prompts" / "tool_plan_verifier.md"),
        tool_planner_model="test-model",
        tool_planner_fallback_model="test-model-fallback",
        tool_verifier_model="test-verifier-model",
        tool_verifier_fallback_model="test-verifier-fallback",
        tool_planner_timeout_seconds=1.0,
        tool_planner_retries=0,
        tool_planner_max_calls=8,
        tool_response_model="test-response-model",
