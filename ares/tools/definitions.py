...
def get_tool_definitions() -> list[dict]:
    ...
    return [
        ...
        _tool("get_goal_status", "Get one goal with its recursive child tree, task/action links, revision, due state, and progress timeline.", {"goal_id": {"type": "integer"}, "timeline_limit": {"type": "integer", "default": 20}}, ["goal_id"]),
        _tool("complete_goal", "Mark a goal completed only when the user confirms completion. Sets progress to 100 and records timeline evidence.", {"goal_id": {"type": "integer"}, "expected_revision": {"type": "integer"}}, ["goal_id"]),
